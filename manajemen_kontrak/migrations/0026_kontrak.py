# Generated by Django 3.1.1 on 2021-05-02 06:23
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('manajemen_kontrak', '0025_delete_kontrak'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('barang', models.ManyToManyField(to='manajemen_kontrak.Barang')),
                ('dibuat_oleh', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='manajemen_kontrak.useradmin')),
            ],
        ),
    ]
